...
export default function BTPSidebar({ stats, tops, rcp, selected, onSelect }) {
  const [topN, setTopN] = useState(10);
  // enforcement ROI: clearing the top-N corridors relieves this much measured delay
  ...
  return (
    <div className="sidebar">
      ...
      <div className="muted" style={{ marginBottom: 8 }}>
        ...
        {[5, 10, 12].map((n) => (
          <button key={n} className="pill" style={{ cursor: "pointer", border: n === topN ? "1px solid var(--accent)" : "none" }}
